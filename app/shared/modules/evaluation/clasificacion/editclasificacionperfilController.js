...
.controller('evaluation.editclasificacionperfilController', ['$scope','clasificacionperfil','apiServices','$location', function($scope,clasificacionperfil,apiServices,$location){
	...
	var parseacierto = $scope.clasificacionperfil.acierto;

	$scope.clasificacionperfil.acierto = parseInt(parseacierto);
