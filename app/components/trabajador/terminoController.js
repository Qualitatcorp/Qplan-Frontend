...
.controller('terminoController', ['$scope','fichas','trabajadorStorage','$sce','$location','$timeout','toastr', function($scope,fichas,trabajadorStorage,$sce,$location,$timeout,toastr){
  	// toastr.info('Pronto volvera al comienzo favor acercarse a la mesa', 'Información');
	// $timeout(function() {
	// 	$location.path('/');
	// },10000)
    $scope.fichas=fichas.data;
