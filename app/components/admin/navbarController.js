		...
		var	sessionStatus=function() {
				if(session.expire){
					...
					if($scope.menu.length==0){
							$scope.menu=[
								{"name":"Administración","items":[{"label":"Sistema","items":[{"label":"Usuarios","href":"users/admin"},{"label":"Roles","href":"users/role"},{"label":"Recursos","href":"users/resource"},{"label":"Clientes","href":"users/clients"},{"label":"Accesos","href":"users/authentication"}]}]},
